module.exports = {
  ...
  createUpdateProduct(payload, callback) {
    return this.v3post(`${this.accountId}/shopper_activity/product`, { payload }, callback);
  }
  createUpdateOrder(payload, callback) {
    return this.v3post(`${this.accountId}/shopper_activity/order`, { payload }, callback);
  }
};
